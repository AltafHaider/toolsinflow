...
return [
    ...
    'tools' => [
        ...
        'study-ppt' => [
            ...
            'desc' => 'Enter a topic or paste study notes to create student-ready PowerPoint slides with definition, uses, properties, pros/cons when available, examples, and a conclusion — plus 30 professional designs.',
            'cat'  => 'study',
        ],
        'compress-image' => [
            'name' => 'Compress Image',
